    ...
    <div className="about_Establishment">
      <div className="Establishment_Wrapper" ref={sectionRef}>
        <div className="left" ref={sectionRef}>
          ...
          <div className="box">
            <p className="year" ref={(el) => (yearsRef.current[0] = el)}>1990</p>
            <p className="year other-years" ref={(el) => (yearsRef.current[1] = el)}>1993</p>
            <p className="year other-years" ref={(el) => (yearsRef.current[2] = el)}>1993</p>
          </div>
        </div>
        <div className="right">
          <div>
